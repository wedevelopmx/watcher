...
let cronjobs = [
  ...
  { name: 'analytics', schedule: '00 * */1 * * *', command: 'node scripts/user-analytics.js >> log/user-analytics.log'},
  { name: 'last-seen', schedule: '00 * 7 * * *', command: 'node scripts/last-seen-lead.js >> log/last-seen-lead.log'}
];
