...
let cronjobs = [
  ...
  { name: 'unfollow', schedule: '00 */10 * * * *', command: 'node scripts/unfollow.js | tee -a log/unfollow.log'},
  { name: 'follow', schedule: '00 */15 4-18 * * *', command: 'node scripts/follow.js | tee -a log/follow.log'},
